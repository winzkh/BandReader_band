<template>
  <div class="page">
    ...
    <div if="{{isDel}}" class="opt">
      ...
      <div style="margin-top: 18px;margin-bottom: 24px;justify-content: center;align-items: center">
        <text style="font-size: 64px;line-height: 64px;">确认删除吗
        </text>
      </div>

      <text class="font-gray" style="width: 100%;font-size: 50px;text-align: center;margin-bottom: 24px">{{
          name
        }}
      </text>
    ...
    <div if="{{!isDel}}" style="position: absolute;top: 0px;left: 0px">
